...
class TestKegs:
    ...
    def setup(self):
        self.bug = Kegs()       # создадим новый мешок
    ...
    def test_get_random_keg(self):
        ...
        result = full_bug - set(self.bug.numbers)   # сравнили начальный мешок с текущим
        assert result == {next_number}              # разница должна быть = вытянутому бочонку
